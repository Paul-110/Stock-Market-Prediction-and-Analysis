			...
			<div class="header-content">
                ...
                <nav class="navigation">
                    <ul class="nav-menu">
                        ...
                        <li class="nav-item active"><a href="CompanyLogin.jsp" class="nav-link"><img src="images/company.png" alt="Company" class="nav-icon-img"/><span>Company</span></a></li>
            ...
            <div class="container">
                <div class="form-container">
                    ...
                    <form name="company" action="CompanyRegAction.jsp" method="post">
                        ...
                        <div class="form-group">
                            <label for="companyid">Register ID</label>
                        ...
                        <div class="form-group">
                            <label for="product">Produced Products</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="turnover" name="turnover" placeholder="min 10lacks" required>
                        </div>
                        <div class="form-group">

...
<!-- content -->
	<section id="content">
            <div class="page-header">
                <div class="container">
                    <h2>RSS (Really Simple Syndication) Feed</h2>
                </div>
            </div>
            <div class="container">
                <div class="table-container">
                    <h3 style="margin-bottom: 1rem;">Welcome, <%=username%>! Here are the latest articles, ordered by quality.</h3>
                        ...
                        <tbody>
                            ...
                            <%
                                ...
                                try {
                                    ...
                                    String sql = "select * from publish order by quality desc";

	...
	<section id="content">
            ...
            <div class="container">
                <div class="content-card" style="max-width: 600px; margin: 2rem auto; text-align: center;">
                    ...
                    <div class="card-icon"><img src="images/negative.png" alt="Negative" class="card-icon-img"/></div>
                    <h3>Negative Outlook</h3>
                    <p style="font-size: 1.2rem; color: var(--text-color);">
                        Hello, <strong><%=username%></strong>! Based on our analysis, your purchased company share value has a negative outlook.
                    </p>
                    <p style="font-size: 1.5rem; font-weight: bold; color: #dc3545; margin: 1rem 0;">
                        Potential Decrease: ₹<%=String.format("%.2f", value)%>
                    </p>

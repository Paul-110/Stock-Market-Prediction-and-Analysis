			...
			<div class="header-content">
                ...
                <nav class="navigation">
                    <ul class="nav-menu">
                        ...
                        <li class="nav-item active"><a href="ShareHolders.jsp" class="nav-link"><img src="images/shareholders.png" alt="Shareholders" class="nav-icon-img"/><span>Shareholders</span></a></li>
...
<!-- content -->
	<section id="content">
            <div class="page-header">
                <div class="container">
                    <h2>Shareholder Details for <%=companyname%></h2>
                </div>
            </div>
            <div class="container">
                <div class="table-container">
                    <table id="shareholderTable" class="modern-table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <%
                                ...
                                try {
                                    ...
                                    String sql = "select * from purchaseshare where companyname = ?";
...
<script>
    $(document).ready( function () {
        $('#shareholderTable').DataTable({
            dom: 'Bfrtip', // This is to display the buttons
            buttons: [
                'csvHtml5'
            ]
        });

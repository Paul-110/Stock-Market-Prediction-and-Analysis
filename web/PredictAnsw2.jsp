            ...
            <div class="container">
                <div class="content-card" style="max-width: 600px; margin: 2rem auto; text-align: center;">
                    <%
                        ...
                        double a3 = (Double)session.getAttribute("a3");
                        double value2 = 100 * a3 / 100;
                    %>
                    <div class="card-icon"><img src="images/neutral.png" alt="Neutral" class="card-icon-img"/></div>
                    <h3>Neutral Outlook</h3>
                    <p style="font-size: 1.2rem; color: var(--text-color);">
                        Hello, <strong><%=username%></strong>! Based on our analysis, your purchased company share value has a neutral outlook.
                    </p>
                    <p style="font-size: 1.5rem; font-weight: bold; color: #6c757d; margin: 1rem 0;">
                        The value may remain stable or see a slight increase of ~<%=String.format("%.2f", value2)%>
                    </p>

	...
	<section id="content">
            <div class="container">
                <div class="form-container">
                    <h2>Article Publisher Login</h2>
                    <form name="articleLogin" action="ArticleLoginAction.jsp" method="post">
                        <div class="form-group">
                            <label for="articlename">Article Name / Username</label>
                        ...
                        <div style="text-align: center; margin-top: 1rem;">
                            <p>New Publisher? <a href="ArtcleRegister.jsp" class="form-link">Register Here</a></p>
                        </div>
                    </form>
                </div>
            </div>
